...
export class DynamodbDocumentClient {
  ...
  async delete(key, params = {}) {
    ...
    try {
      ...
      const data = formatDeleteResponse(res)
  ...
  async query(params = {}) {
    ...
    try {
      ...
      const data = formatQueryResponse(res)
...
const formatDeleteResponse = formatPutResponse

const formatQueryResponse = ({ Items, LastEvaluatedKey }) => [
  Items,
